...
namespace SwissHerbalTests.PageObjects.ItemPage
{
    public class ItemPageLocators
    {
        ...
        public IWebElement AddToWaitingListButton => _driver.FindElement(By.ClassName("xoo - wl - btn button btn"));
        ...
        public IWebElement AddToWaitingListModal => _driver.FindElement(By.ClassName("xoo - wl - inmodal"));
